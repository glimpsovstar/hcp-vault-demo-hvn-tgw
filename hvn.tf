...
resource "hcp_aws_transit_gateway_attachment" "djoo_hcp_vault_demo_tgw_attachment" {
  ...
  transit_gateway_attachment_id = "djoo-hcp-vlt-demo-hvn-tgw-attachment"
...
resource "hcp_hvn_route" "djoo_hcp_vault_demo_route" {
  ...
  hvn_route_id     = "djoo-hcp-vlt-demo-hvn-to-tgw-attach"
  destination_cidr = aws_vpc.djoo_hcp_vault_demo_vpc.cidr_block
